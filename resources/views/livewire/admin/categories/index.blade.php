        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between  gap-4 mb-6">
                <div class="md:col-span-2">
                    <div class="relative">
                        <i
                            class="ri-search-line absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-lg"></i>
                ...
                <x-button variant="primary" wire:click="addCategory" icon="ri-eye-line" iconPosition="left">
                    Tambah
                </x-button>
            </div>
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center space-x-3">
                    @if ($search)
                        <x-button variant="secondary" size="sm" wire:click="clearFilters"
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center space-x-1">
                                        <x-button variant="success" size="xs"
                                            wire:click="editCategory({{ $category->id }})" icon="ri-eye-line"
                                            iconPosition="left">
                                            Edit
                                        </x-button>
                                        <x-button variant="danger" size="xs"
                                            wire:click="confirmDelete({{ $category->id }})" icon="ri-eye-line"
                                            iconPosition="left">
                                            Hapus
                                        </x-button>
                                    </td>
            ...
            @else
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed">Coba ubah kata kunci pencarian atau filter yang
                            Anda gunakan untuk menemukan Kategori yang sesuai</p>
                        @if ($search)
                            <x-button variant="primary" wire:click="clearFilters"
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <x-button variant="danger" size="sm" wire:click="deleteCategory">Hapus</x-button>
                </div>
            </div>
        </div>
    @endif
