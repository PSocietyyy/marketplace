<div class="min-h-screen min-w-full bg-gray-50 text-gray-900 px-4 sm:px-6 lg:px-8 py-12 max-w-6xl mx-auto">
    ...
    <div class="mb-10">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 text-lg max-w-2xl mx-auto">Temukan UMKN terbaik dan produk unggulan yang direkomendasikan untuk Anda</p>
        </div>
    </div>
            ...
            @empty
                <div class="col-span-full text-center py-16">
                    <div class="max-w-sm mx-auto">
                        ...
                        <p class="text-gray-600 text-sm">Produk terlaris akan ditampilkan di sini ketika sudah tersedia</p>
                    </div>
                </div>
            @endforelse
        </div>
