                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    <div class="flex items-center">
                                        @for($i = 1; $i <= 5; $i++)
                                            <i class="ri-star{{ $i <= round($averageRating) ? '-fill text-yellow-400' : '-line text-gray-300' }} text-sm"></i>
                                        @endfor
                                    </div>
                                    <span class="font-medium text-gray-900">{{ number_format($averageRating, 1) }} ({{ $totalReviews }} ulasan)</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-8 py-6 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">{{ $totalReviews }} ulasan dengan rating rata-rata {{ number_format($averageRating, 1) }}</p>
                        </div>
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                @for($i = 1; $i <= 5; $i++)
                                    <i class="ri-star{{ $i <= round($averageRating) ? '-fill text-yellow-400' : '-line text-gray-300' }} text-xl"></i>
                                @endfor
                            </div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        <div class="flex items-center">
                                                            @for($i = 1; $i <= 5; $i++)
                                                                <i class="ri-star{{ $i <= $review->rating ? '-fill text-yellow-400' : '-line text-gray-300' }} text-sm"></i>
                                                            @endfor
                                                        </div>
                                                ...
                                                @foreach($review->replies as $reply)
                                                    <div class="bg-gray-50 p-4 rounded-xl">
                                                        <div class="flex items-start space-x-3">
                                                            ...
                                                            <div class="flex-1">
                                                                <div class="flex items-center space-x-2">
                                                                    <p class="font-medium text-gray-900 text-sm">{{ $reply->user->first_name . " " . $reply->user->last_name }}</p>
                                                                    <span class="text-xs text-gray-500">{{ $reply->created_at->diffForHumans() }}</span>
                                                                </div>
                                                                <p class="text-gray-700 text-sm mt-1">{{ $reply->comment }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
