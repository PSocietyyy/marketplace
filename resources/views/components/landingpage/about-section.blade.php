            ...
            <div class="space-y-8 lg:order-last">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 pt-6 max-w-2xl">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-gray-600">Kami membimbing setiap langkah, dari daftar produk hingga promosi.</p>
                    </div>
                    <div class="flex flex-col">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-gray-600">Semua pembayaran dijamin aman dan terpercaya.</p>
                    </div>
                </div>
            </div>
