            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('admin.dashboard') ? 'bg-gray-50 text-gray-900' : '' }}">
                        <i class="ri-dashboard-line text-lg mr-3 text-gray-500 group-hover:text-gray-700 {{ request()->routeIs('admin.dashboard') ? 'text-gray-700' : '' }}"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.product.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('admin.product.*') ? 'bg-gray-50 text-gray-900' : '' }}">
                        <i class="ri-store-line text-lg mr-3 text-gray-500 group-hover:text-gray-700 {{ request()->routeIs('admin.product.*') ? 'text-gray-700' : '' }}"></i>
                        <span>Manajemen Produk UMKN</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.orders') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group {{ request()->routeIs('admin.order') ? 'bg-gray-50 text-gray-900' : '' }}">
                        <i class="ri-list-ordered text-lg mr-3 text-gray-500 group-hover:text-gray-700 {{ request()->routeIs('admin.order') ? 'text-gray-700' : '' }}"></i>
